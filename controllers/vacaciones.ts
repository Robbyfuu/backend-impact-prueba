...
export const getVacacionesTrabajador = async (req: Request, res: Response) => {
...
export const getVacacionesTerminadas = async (req: Request, res: Response) => {
  try {
    const vacaciones = await Vacaciones.findAll({
      where: {
...
// vacaciones activas
export const getVacacionesActivas = async (req: Request, res: Response) => {
  try {
    const vacaciones = await Vacaciones.findAll({
      where: {
...
//crear vacacion
export const postVacaciones = async (req: Request, res: Response) => {
  const { body } = req;
  try {
...
//actualizar vacacion
export const putVacaciones = async (req: Request, res: Response) => {
    const { id } = req.params;
    const { body } = req;
    try {
    ...
    //eliminar vacacion
    export const deleteVacaciones = async (req: Request, res: Response) => {
    const { id } = req.params;
    try {
        const vacacion = await Vacaciones.findByPk(id);
        if (!vacacion) {
    ...
    export const postVacacionesMasivo = async (req: Request, res: Response) => {
    const { body } = req;
    try {
/*         const trabajador = await Trabajador.findByPk(body.ficha);
        if (!trabajador) {
